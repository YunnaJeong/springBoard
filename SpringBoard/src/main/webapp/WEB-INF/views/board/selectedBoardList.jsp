...
<body>
	...
	<div style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
		<h3>게시글 목록</h3>
		<form id="searchForm" action="/board/selectedBoardList.do" method="post">
		...
		<table id="boardTable" border="1" style="width: 700px; border-collapse: collapse;">
			<tr>
				<th style="backgrond: #0A82FF; width: 80px;">번호</th>
				<th style="backgrond: #0A82FF; width: 400px;">제목</th>
				<th style="backgrond: #0A82FF; width: 150px;">작성자</th>
				<th style="backgrond: #0A82FF; width: 150px;">등록일</th>
				<th style="backgrond: #0A82FF; width: 100px;">조회수</th> 
			</tr>
			<c:forEach items="${boardList }" var="board">
				<tr>
					<td>${board.boardNo }</td>
					<td>
						<a href="/board/selectedBoard.do?boardNo=${board.boardNo }">${board.boardTitle }</a>
					</td>
